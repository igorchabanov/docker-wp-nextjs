...
if ( $return_format == 'object' ) {
	...
	if($taxonomy_field_type == 'select' || $taxonomy_field_type == 'radio') {
		echo $this->indent . htmlspecialchars("<?php \$".$this->var_name."_term = " . $this->get_field_method . "( '" . $this->name ."'". $this->location . " ); ?>")."\n";
	...
	if($taxonomy_field_type == 'multi_select' || $taxonomy_field_type == 'checkbox') {
		echo $this->indent . htmlspecialchars("<?php \$".$this->var_name."_terms = " . $this->get_field_method . "( '" . $this->name ."'". $this->location . " ); ?>" )."\n";
...
if ( $return_format == 'id' ) {
	echo $this->indent . htmlspecialchars("<?php \$".$this->var_name."_ids = " . $this->get_field_method . "( '" . $this->name ."'". $this->location . " ); ?>")."\n";
