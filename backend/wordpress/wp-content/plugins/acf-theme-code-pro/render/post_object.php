...
if( $return_format == 'object' && $multiple_values == '0' ) {
	echo $this->indent . htmlspecialchars("<?php \$post_object = " . $this->get_field_method . "( '" . $this->name ."'". $this->location . " ); ?>")."\n";
...
if( $return_format == 'object' && $multiple_values == '1' ) {
	echo $this->indent . htmlspecialchars("<?php \$post_objects = " . $this->get_field_method . "( '" . $this->name ."'". $this->location . " ); ?>")."\n";
