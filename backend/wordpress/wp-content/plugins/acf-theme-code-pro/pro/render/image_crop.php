...
if ( $return_format == 'array' || $return_format == 'object'  ) {
	echo $this->indent . htmlspecialchars("<?php \$image = " . $this->get_field_method . "( '" . $this->name ."'". $this->location . " ); ?>")."\n";
...
if ( $return_format == 'url' ) {
	...
	echo $this->indent . htmlspecialchars("	<img src=\"<?php " . $this->the_field_method . "( '" . $this->name ."'". $this->location . " ); ?>\" />\n");
	echo $this->indent . htmlspecialchars("<?php } ?>\n");
}
